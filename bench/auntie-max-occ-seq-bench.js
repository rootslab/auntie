/*
 * Auntie benchmark, fill a buffer with patterns.
 */
...
for ( let i = 0; i < q; ++i ) seq.copy( data, i * slen );
...
log( '\n-> parsing occurrences using #do (expected 0 slices)..' );
...
log( ' - total percentage of matching data: %d%', 100 - perc );
