...
/*
  TODO/MISSING:
  - efficient #dist/#count methods for a single char sequence to parse, as for
    #do (needle and search). Fix relative benchmark and write tests.
  - memory efficient code for #dist and relative (deep) tests.
...
exports.Auntie = ( function () {
    ...
    const log = console.log
        ...
        // default fn for #do method
        , search = function ( data, collect ) {
            const me = this
                // counter / parser
                , bop = me.bop
        ...
        , needle = function ( data, collect ) {
            ...
            i = 0;
            if ( ! mlen ) {
                // no results, save snip and retunr
        ...
        , Auntie = function ( sequence ) {
            ...
            // if seq is made of a single char, assign needle function to #do 
            if ( me.seq.length === 1 ) me.do = needle;
        }
        ;
    ...
    aproto.set = function ( sequence ) {
        ...
        me.cnt = [ 0, Infinity, -Infinity ];
        // if seq is made of a single char, assign needle function to #do 
        me.do = ( me.seq.length > 1 ) ? dosplit : needlesplit;
        return me;
    };
