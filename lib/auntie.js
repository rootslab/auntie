...
/*
  TODO/MISSING:
  - efficient #dist methods for a single char sequence to parse, as for
    #do and #count (full/naive). Fix relative benchmark and write tests.
  - add test when setting pattern (naive/complex)
