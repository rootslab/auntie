...
exports.Auntie = ( function () {
    ...
    const log = console.log
        ...
        , Auntie = function ( sequence ) {
            ...
            // for counter
            me.csnip = ualloc( 0 );
            me.cnt = [ 0, Infinity, -Infinity, 0 ];
            me.gbop = Bop( ualloc( 0 ) );
            // if seq is made of a single char, assign naive function to #do 
            if ( me.seq.length === 1 )
                [ me.do, me.count, me.dist ] = [ naive.do, naive.count, naive.dist ];
        }
        ;
    ...
    aproto.set = function ( sequence ) {
        ...
        [ me.do, me.count, me.dist ] = ( me.seq.length > 1 ) ?
            [ complex.do, complex.count, complex.dist ] : [ naive.do, naive.count, naive.dist ];
        return me;
    };
